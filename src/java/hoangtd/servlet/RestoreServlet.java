 ...
 * @author Dell
 */
@WebServlet(name = "RestoreServlet", urlPatterns = {"/RestoreServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try {
            ...
            if (session != null) {
                ...
                if (userDTO != null) {
                    if (userDTO.getRole().equals("admin")) {
                        ...
                        boolean result = articleDAO.restoreStatusBlog(title);
                        if (result) {
                            request.setAttribute("SUCCESS", "Restore Blog Successfully");
                        } else {
                            request.setAttribute("FAIL", "Restore Blog FAILED!!!");
                        }
                    }
                }
            }
            ...
            log("RestoreServlet NamingException " + e.getMessage());
        } catch (SQLException e) {
            log("RestoreServlet SQLException " + e.getMessage());
        } finally {
