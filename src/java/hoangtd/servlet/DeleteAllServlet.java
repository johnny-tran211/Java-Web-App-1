...
public class DeleteAllServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] titles = request.getParameterValues("cbxDelete");
        ...
        try {
                    ...
                    if (userDTO.getRole().equals("admin")) {
                        ...
                        if (titles != null) {
                            ...
                            for (int i = 0; i < titles.length; i++) {
                                articleDAO.deleteStatusBlog(titles[i], STATUS);
                            }
                        } else {
                            request.setAttribute("CHECKBOXEMPTY", "Check titles that you want to delete");
                        }
                    }
                }
            }
            ...
            log("NamingException DeleteAllServlet " + e.getMessage());
        } catch (SQLException e) {
            log("SQLException DeleteAllServlet " + e.getMessage());
        } finally {
